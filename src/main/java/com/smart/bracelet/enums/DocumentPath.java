...
//    WORD_TEMPLATE_PAYMENT("收据（预付款）","D:/doc/","prepaid.docx"),
    ...
    WORD_TEMPLATE_CUMOUT("信息分析暨尽调协议", "/root/upload/docFile/", "information.docx"),
    WORD_TEMPLATE("策划方案服务协议", "/root/upload/docFile/", "planningPlan.docx"),
    WORD_TEMPLATE_TRANSFER("债权转让协议","/root/upload/docFile/","claimsTransfer.docx"),
    WORD_TEMPLATE_CONFIRM("债权转让确认书","/root/upload/docFile/","claimsTransferConfirm.docx"),
    WORD_TEMPLATE_NOTICE("债权转让通知书","/root/upload/docFile/","claimsTransferNotice.docx"),
    WORD_TEMPLATE_PROVE("债权确认书","/root/upload/docFile/","claimsConfirm.docx"),
    WORD_TEMPLATE_LETTER("催款函","/root/upload/docFile/","dunningLetter.docx"),
...
//    PDF_SAVE_PAYMENT("收据（资产补偿金）","D:/doc/",""),
    ...
    PDF_SAVE_CUMOUT("JiJinXieYi", "/root/upload/docFile/", ""),
    PDF_SAVE("CeHuaFangAnXieYi", "/root/upload/docFile/", ""),
    PDF_SAVE_TRANSFER("ZhaiQuanZhuanRangXieYi", "/root/upload/docFile/", ""),
    PDF_SAVE_CONFIRM("ZhaiQuanZhuanRangQueRenShu","/root/upload/docFile/",""),
    PDF_SAVE_NOTICE("ZhaiQuanZhuanRangTongZhiShu","/root/upload/docFile/",""),
    PDF_SAVE_PROVE("ZhaiQuanQueRenShu","/root/upload/docFile/",""),
    PDF_SAVE_LETTER("CuiKuanHan","/root/upload/docFile/",""),
    PDF_SAVE_CONSIG("WeiTuoDaiLiXiaoShouHeTong","/root/upload/docFile/",""),
    PDF_SAVE_RECILIATION("HeJieXieYi","/root/upload/docFile/",""),
    PDF_SAVE_ONLINECONSIG("WeiTuoXianShangDaiLiXiaoShouHeTong","/root/upload/docFile/",""),
    PDF_SAVE_REPORT("BaoBeiFei","/root/upload/docFile/",""),
    PDF_SAVE_ADVISORY("ZiXunFuWuFei","/root/upload/docFile/",""),
    PDF_SAVE_PAYMENT("ZiChanBuChangJin","/root/upload/docFile/",""),
    ;
