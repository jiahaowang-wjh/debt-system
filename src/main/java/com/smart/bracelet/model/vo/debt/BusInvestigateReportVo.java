 ...
 */
@Data
public class BusInvestigateReportVo {
    /**
     * 报告ID
     */
     ...
     * 小贷公司
     */
    @NotNull(message = "小贷公司不能为空")
    private Float smallCompany;

    /**
     * 担保公司
     */
    @NotNull(message = "担保公司不能为空")
    private Float guaranteeCompany;

    /**
     * 基金公司
     */
    @NotNull(message = "基金公司不能为空")
    private Float fundCompany;
     ...
     * 项目施工欠款
     */
    @NotBlank(message = "项目施工欠款不能为空")
    private String projectArrears;
     ...
     * 涉及司法
     */
    @NotNull(message = "涉及司法不能为空")
    private Integer involvingJustice;
    ...
    private Integer prodousGrossprofit1;

    /**
     * 纯利1
     */
    @NotNull(message = "纯利1不能为空")
    private Integer netprofit1;
    ...
    private Integer prodousGrossprofit2;

    /**
     * 纯利2
     */
    @NotNull(message = "纯利2不能为空")
    private Integer netprofit2;
     ...
     * 房产-评估价值
     */
    @NotBlank(message = "房产-评估价值不能为空")
    private String houseAccessValue;
     ...
     * 住宅1
     */
    @NotNull(message = "住宅1不能为空")
    private Integer residence1;

    /**
     * 住宅-评估价值
     */
    @NotNull(message = "住宅-评估价值不能为空")
    private Integer residenceAccessValue;
     ...
     * 商业1
     */
    @NotNull(message = "商业1不能为空")
    private Integer busines1;

    /**
     * 商业-评估价值
     */
    @NotNull(message = "商业-评估价值不能为空")
    private Integer businesAccessValue;
     ...
     * 厂房-评估价值
     */
    @NotNull(message = "厂房-评估价值不能为空")
    private Integer workshopAccessValue;
     ...
     * 设备-评估价值
     */
    @NotNull(message = "设备-评估价值不能为空")
    private Integer deviceAccessValue;
     ...
     * 通用设备
     */
    @NotNull(message = "通用设备不能为空")
    private Integer commonDevice;

    /**
     * 其它-评估价值
     */
    @NotNull(message = "其它-评估价值不能为空")
    private Integer oterAccessValue;
