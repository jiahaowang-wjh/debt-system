...
public class BusCivilVo implements Serializable {
    ...
    public void setCerateUserId(Long cerateUserId) {
        this.cerateUserId = cerateUserId;
    }
    ...
    public boolean equals(Object that) {
        ...
        BusCivilVo other = (BusCivilVo) that;
        return (this.getCivilId() == null ? other.getCivilId() == null : this.getCivilId().equals(other.getCivilId()))
            ...
            && (this.getCerateUserId() == null ? other.getCerateUserId() == null : this.getCerateUserId().equals(other.getCerateUserId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getCivilId() == null) ? 0 : getCivilId().hashCode());
        ...
        result = prime * result + ((getCerateUserId() == null) ? 0 : getCerateUserId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", civilId=").append(civilId);
        ...
        sb.append(", cerateUserId=").append(cerateUserId);
